...
import com.appsdevloperblog.photoapp.api.users.ui.model.UserResponseModel;
...
public class UsersController {
	...
	public ResponseEntity<CreateUserRequestModel> createUser(@Valid @RequestBody CreateUserRequestModel userDetails) {
		...
		CreateUserRequestModel retVal = modelMapper.map(createdUser, CreateUserRequestModel.class);
